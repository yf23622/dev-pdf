...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      editorCoverInkButton: document.getElementById("editorCoverInkButton"),
      editorCoverInkParamsToolbar: document.getElementById(
        "editorCoverInkParamsToolbar"
      ),
    ...
    annotationEditorParams: {
      ...
      editorCoverInkColor: document.getElementById("editorCoverInkColor"),
      editorCoverInkOpacity: document.getElementById("editorCoverInkOpacity"),
