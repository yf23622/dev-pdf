...
class Toolbar {
  ...
  constructor(options, eventBus, toolbarDensity = 0) {
    ...
    const buttons = [
      ...
      {
        element: options.editorCoverInkButton,
        eventName: "switchannotationeditormode",
        eventDetails: {
          get mode() {
            const { classList } = options.editorCoverInkButton;
            return classList.contains("toggled")
              ? AnnotationEditorType.NONE
              : AnnotationEditorType.COVERINK;
          },
        },
      },
      {
  ...
  #editorModeChanged({ mode }) {
    ...
    toggleExpandedBtn(
      editorCoverInkButton,
      mode === AnnotationEditorType.COVERINK,
      editorCoverInkParamsToolbar
    );
    toggleExpandedBtn(
      editorStampButton,
