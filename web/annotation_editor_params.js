 ...
 * @property {HTMLInputElement} editorCoverInkColor
 * @property {HTMLInputElement} editorCoverInkOpacity
...
class AnnotationEditorParams {
  ...
  #bindListeners({
    ...
    editorCoverInkColor?.addEventListener("input", function () {
      dispatchEvent("INK_COLOR", this.value);
    });
    ...
    editorCoverInkOpacity?.addEventListener("input", function () {
      dispatchEvent("INK_OPACITY", this.valueAsNumber);
    });
      ...
      for (const [type, value] of evt.details) {
        switch (type) {
          ...
          case AnnotationEditorParamsType.INK_COLOR:
            ...
            if (editorCoverInkColor) editorCoverInkColor.value = value;
            break;
          case AnnotationEditorParamsType.INK_OPACITY:
            editorInkOpacity.value = value;
            if (editorCoverInkOpacity) editorCoverInkOpacity.value = value;
            break;
