...
class AnnotationEditorUIManager {
  ...
  a11yAlert(messageId, args = null) {
    ...
    if (!messageId || typeof messageId !== "string") {
      viewerAlert.removeAttribute("data-l10n-id");
  ...
  updateParams(type, value) {
    ...
    // Track CoverInk drawing parameters
    if (type === AnnotationEditorParamsType.INK_COLOR) {
      this.currentDrawingColor = value;
    } else if (type === AnnotationEditorParamsType.INK_OPACITY) {
      this.currentDrawingOpacity = value;
    }
